...
for ii = 1:nCrops
    ...
    ParamStruct.Crop.(CropInfo{1,1}{ii}).Aer = 5; % Vol (%) below saturation at which stress begins to occur due to deficient aeration
    ParamStruct.Crop.(CropInfo{1,1}{ii}).LagAer = 3; % Number of days lag before aeration stress affects crop growth
    ...
    ParamStruct.Crop.(CropInfo{1,1}{ii}).fsink = ParamStruct.Crop.(CropInfo{1,1}{ii}).fsink/100; % Adjust input values from percentage to fraction
end
